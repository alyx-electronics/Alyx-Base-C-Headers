...
if (NOT ALYX_HEADER_PATH)
    if (ALYX_HEADER_FETCH_FROM_GIT)
        ...
        FetchContent_Declare(
                alyx_base_c_header
                GIT_REPOSITORY https://github.com/alyx-electronics/Alyx-Base-C-Headers.git
                GIT_TAG main
        )
        if (NOT alyx_base_c_headers)
            message("Downloading Alyx Base C Headers ...")
            FetchContent_Populate(alyx_base_c_header)
...
add_subdirectory(${ALYX_HEADER_PATH} alyx_base_c_headers)
